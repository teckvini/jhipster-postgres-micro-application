...
@AnalyzeClasses(packagesOf = JhipsterPostgresMicroTestApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(JhipsterPostgresMicroTestApp.class), alwaysTrue())
